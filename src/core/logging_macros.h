...
// 为了向后兼容，提供旧的宏接口
#define LOG_INFO_MSG(msg) Logger::instance().info(msg)
#define LOG_WARNING_MSG(msg) Logger::instance().warning(msg)
#define LOG_ERROR_MSG(msg) Logger::instance().error(msg)
#define LOG_DEBUG_MSG(msg) Logger::instance().debug(msg)
